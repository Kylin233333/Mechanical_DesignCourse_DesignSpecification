...
选择的型号为双A型键$b\times h \times L = 10\times 8\times 63$，双键相隔$180^\circ$布置。\\
键的工作长度$l=1.5(L-b)=1.5(63-10)=79.5mm$\\
齿轮材料为40Cr，载荷平稳取$[\sigma_p] = 150 \text{ MPa}$，
则其挤压强度为：
\begin{equation}
    \sigma_p = \frac{4000T}{hld} = \frac{4000\times 531.35}{8\times 79.5\times 32.5}=102.82 \text{ MPa}
\end{equation} 
$\sigma_p < [p]$，故满足强度要求
\subsection{联轴器键连接计算校核}
