...
选择的型号为A型键$b\times h \times L = 20\times 12\times 63$\\
键的工作长度$l=L-b=63-20=64.5mm$\\
齿轮材料为40Cr，载荷平稳取$[\sigma_p] = 150 \text{ MPa}$，
则其挤压强度为：
\begin{equation}
    \sigma_p = \frac{4000T}{hld} = \frac{4000\times 531.35}{12\times 64.5\times 32.5}=126.73 \text{ MPa}
\end{equation} 
$\sigma_p < [p]$，故满足强度要求
\subsection{联轴器键连接计算校核}
